...
public class PersonMain {
    public static void main(String[] args) throws Exception{
        ...
        Class<Person> personClass = (Class<Person>) Class.forName("day06.api.Person");
        ...
        Method privateTotal = personClass.getDeclaredMethod("privateTotal", int.class, int.class); //private는 getMethod 불가
